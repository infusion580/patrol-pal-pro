  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-3 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:left-4 sm:h-14 sm:w-14" style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 5.5rem)' }}
      >
      ...
      {open && (
        <div
          ...
          className="fixed left-3 right-3 z-50 max-h-[70dvh] overflow-y-auto rounded-xl border border-border bg-card p-4 shadow-xl sm:left-4 sm:right-auto sm:w-[22rem]" style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 9.5rem)' }}
        >
