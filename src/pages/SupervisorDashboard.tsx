...
import { Users, CheckCircle2, AlertTriangle, Clock, MapPin, FileText, BarChart3, Settings, Bell, UserCog, Target, Trophy, ClipboardList, ShieldCheck, Award, Megaphone, HandCoins, AlarmClock,} from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto px-4 -mt-4">
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          {[
            ...
            { icon: HandCoins, label: 'Préstamos', path: '/prestamos' },
