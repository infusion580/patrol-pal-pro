      ...
      <div className="max-w-lg mx-auto px-4 mt-4 space-y-4">
        <div className="bg-card rounded-xl p-4 shadow-card space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Describe las incidencias ocurridas durante el turno..."
          ...
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Lista las actividades realizadas..."
        ...
        <div className="bg-card rounded-xl p-4 shadow-card">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <button
                key={item.label}
                className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-accent hover:bg-accent/80 transition-colors"
              >
