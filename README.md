...
- Sesión persistente con límites conocidos (una sola sesión por usuario, por navegador/perfil; se pierde al borrar datos del sitio). Ver `IMPLEMENTACION_COMPLETA.md` §14.
